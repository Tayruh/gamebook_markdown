...
## <center>**Example Book**<br/>*just a sample*</center>
...
If you'd like to check above the door, turn to [3](#3). If you'd like to examine the potted plants beneath the window, turn to [4](#4). If you think that the loose tile on the walkway needs further inspection, turn to [5](#5).
...
If you go with Chelsea, turn to [9](#9). If you decide to go with Alicia, turn to [10](#10).
